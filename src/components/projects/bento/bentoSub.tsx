      ...
      <div className="w-full flex flex-row justify-end gap-4">
        {link.length !== 0 && (
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-[#26568a] h-11 w-11 outline outline-1 outline-transparent hover:outline-[#6e97c5] active:outline-[#c1d3e6] text-tesla-text font-medium p-2.5 rounded-lg duration-150"
          >
