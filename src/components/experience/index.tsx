...
const WorkSection = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-tesla-800 h-[680px] mb-24 w-full flex flex-row justify-center items-center"
    >
      <section className="w-[880px] h-full py-14 flex flex-row flex-wrap gap-6 ">
                        ...
                        <ul className="flex flex-col gap-2 list-disc">
                          {item.description.map((desc, docI) => (
                            <li
                              ...
                              className="pl-2 text-base text-slate-400 "
                            >
                              {desc}
                            </li>
                          ))}
